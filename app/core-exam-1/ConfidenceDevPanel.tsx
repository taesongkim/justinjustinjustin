...
const CONTROLS: Control[] = [
  { var: "--cs-size", label: "Handle · rest size", min: 3, max: 40, step: 1, unit: "px", default: 6 },
  { var: "--cs-size-active", label: "Handle · active size", min: 10, max: 64, step: 1, unit: "px", default: 24 },
  { var: "--cs-track-w", label: "Track width", min: 24, max: 260, step: 1, unit: "px", default: 50 },
  { var: "--cs-rail-h", label: "Rail thickness", min: 1, max: 8, step: 1, unit: "px", default: 1 },
  { var: "--cs-notch", label: "Notch size", min: 2, max: 18, step: 1, unit: "px", default: 4 },
  ...
  { var: "--cs-glow-blur", label: "L4 · glow blur", min: 0, max: 30, step: 1, unit: "px", default: 11 },
  ...
  { var: "--cs-rings-scale", label: "L5 · ring max scale", min: 1.5, max: 6, step: 0.1, unit: "", default: 2.3 },
